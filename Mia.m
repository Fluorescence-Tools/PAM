...
h.Mia_Image.Settings.Load_ROI = uicontrol(...
    ...
    'BackgroundColor', Look.Control,...
    'ForegroundColor', Look.Fore,...
    'Position',[0.02 0.02, 0.22 0.06],...
    'Callback',{@Import_ROI},...
    'String','Import ROI',...
    'Tooltipstring','Import ROI from .mat file');
...
switch mode
    ...
    case 3 %%% Loads custom data formats
        ...
        if mode == 3 && numel(str2num(h.Mia_Image.Settings.Custom(4).String))>1
            % user loaded .czi file and specified a rangee of z-planes
