...
h.Mia_Image.Calculations.Cor_Save_ICS = uicontrol(...
    ...
    'String',{'Do not save','Save as .miacor','Save as TIFF', 'Save blockwise analysis as .miacor', 'Save as .miacor for pseudo mapping', 'Local RICS, do not save', 'Local RICS, save as .miacor'});
if ismac
    h.Mia_Image.Settings.ROI_AR_Same.ForegroundColor = [0 0 0];
    h.Mia_Image.Settings.ROI_AR_Same.BackgroundColor = [1 1 1];
...
h.Mia_Image.Calculations.Cor_Save_Name = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','checkbox',...
    'Units','normalized',...
    'FontSize',12,...
    ...
    'BackgroundColor', Look.Back,...
    'ForegroundColor', Look.Fore,...
    'Position',[0.02 0.54, 0.7 0.06],...
    'String','Use automatic filename',...
    'Visible','off');
h.Mia_Image.Calculations.Cor_Block_Text = {};
h.Mia_Image.Calculations.Cor_Block_Text{end+1} = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','text',...
    'Units','normalized',...
    'FontSize',12,...
...
h.Mia_Image.Calculations.Cor_Window = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','edit',...
    'Units','normalized',...
    'FontSize',12,...
...
h.Mia_Image.Calculations.Cor_Offset = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','edit',...
    'Units','normalized',...
    'FontSize',12,...
    'BackgroundColor', Look.Control,...
    'ForegroundColor', Look.Fore,...
    'Position',[0.78 0.40, 0.2 0.06],...
    'String','20',...
    'Visible','off');
h.Mia_Image.Calculations.Cor_Local_Text = {};
h.Mia_Image.Calculations.Cor_Local_Text{end+1} = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','text',...
    'Units','normalized',...
    'FontSize',12,...
    ...
    'ForegroundColor', Look.Fore,...
    'Position',[0.02 0.47, 0.76 0.06],...
    'String','Local ROI [Pix]:',...
    'Visible','off');
%%% Edit box to choose the n.o. frames to slide from one window to the other (RICS)
h.Mia_Image.Calculations.Cor_Local_Size = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','edit',...
    'Units','normalized',...
    'FontSize',12,...
    ...
    'Position',[0.78 0.47, 0.2 0.06],...
    'String','20',...
    'Tooltipstring',['Correlate in local ROIs.' 10 'The center of the first local ROI' 10 'is just inside the large (A)ROI.'],...
    'Visible','off');
h.Mia_Image.Calculations.Cor_Local_Text{end+1} = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','text',...
    ...
    'Visible','off');
%%% Edit box to choose the n.o. frames to slide from one window to the other (RICS)
h.Mia_Image.Calculations.Cor_Local_Offset = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','edit',...
    'Units','normalized',...
    'FontSize',12,...
    ...
    'Position',[0.78 0.40, 0.2 0.06],...
    'String','20',...
    'Tooltipstring',['="local ROI size":' 10 'all local ROIs are adjacent.' 10 '="1": next ROI starts 1 pixel after' 10 'the previous ROI. Warning: ' 10 'for a 200x200 large ROI,' 10 'this will generate 40.000 miacor files!'],...
    'Visible','off');
%%% Checkbox to switch between automatic\manual filenames
h.Mia_Image.Calculations.Cor_Local_NormF = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','checkbox',...
    'Units','normalized',...
    'FontSize',12,...
    ...
    'BackgroundColor', Look.Back,...
    'ForegroundColor', Look.Fore,...
    'Position',[0.02 0.33, 0.7 0.06],...
    'String','Normalize by large-ROI <F>',...
    'Visible','off');
h.Mia_Image.Calculations.Cor_Local_D_Image = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','checkbox',...
    'Units','normalized',...
    'FontSize',12,...
    ...
    'String','D image',...
    'Tooltipstring','Quick diffusion image',...
    'Visible','off');
h.Mia_Image.Calculations.Cor_Local_N_Image = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','checkbox',...
    'Units','normalized',...
    'FontSize',12,...
    ...
    'BackgroundColor', Look.Back,...
    'ForegroundColor', Look.Fore,...
    'Position',[0.02 0.19, 0.7 0.06],...
    'String','N image',...
    'Tooltipstring','Quick concentration image',...
    'Visible','off');
h.Mia_Image.Calculations.Cor_Pseudo_Ilevels = uicontrol(...
    'Parent', h.Mia_Image.Calculations.Cor_Panel,...
    'Style','checkbox',...
    'Units','normalized',...
    'FontSize',12,...
    ...
    'BackgroundColor', Look.Back,...
    'ForegroundColor', Look.Fore,...
    'Position',[0.02 0.12, 0.7 0.06],...
    'String','Divide total I range [bins]:',...
    'Tooltipstring','Calculates correlations in n ROIs between the max and min intensity',...
    'Visible','off');
...
if savedata > 1
    ...
    if savedata ~= 4 %% normal saving
        ...
        % Window size
        if str2double(h.Mia_Image.Calculations.Cor_Window.String) == 0
            h.Mia_Image.Calculations.Cor_Window.String = num2str(floor(numel(Frames)/5));
        end
        Window = str2double(h.Mia_Image.Calculations.Cor_Window.String);
        % Offset size
    ...
    for b = 1:Blocks
        ...
        switch savedata
            case {2,4} %%% .miacor filetype
                ...
                if ~h.Mia_Image.Calculations.Cor_Save_Name.Value
...
MaxLag = str2double(h.Mia_Image.Calculations.Cor_Window.String);
    ...
    switch i
        ...
        case 5
            switch h.Mia_Image.Calculations.Cor_Save_ICS.Value
                case 1
                    h.Mia_Image.Calculations.Cor_Save_Name.Visible = 'off';
                                        for j=1:numel(h.Mia_Image.Calculations.Cor_Block_Text)
                        h.Mia_Image.Calculations.Cor_Block_Text{j}.Visible = 'off';
                    end
                    h.Mia_Image.Calculations.Cor_Window.Visible = 'off';
                    h.Mia_Image.Calculations.Cor_Offset.Visible = 'off';
                    for j=1:numel(h.Mia_Image.Calculations.Cor_Local_Text)
                        h.Mia_Image.Calculations.Cor_Local_Text{j}.Visible = 'off';
                    end
                    h.Mia_Image.Calculations.Cor_Local_Size.Visible = 'off';
                    h.Mia_Image.Calculations.Cor_Local_Offset.Visible = 'off';
                    h.Mia_Image.Calculations.Cor_Local_NormF.Visible = 'off';
                    h.Mia_Image.Calculations.Cor_Local_D_Image.Visible = 'off';
                    h.Mia_Image.Calculations.Cor_Local_N_Image.Visible = 'off';
                    h.Mia_Image.Calculations.Cor_Pseudo_Ilevels.Visible = 'off';
                case 4
                    %% blockwise RICS
                    h.Mia_Image.Calculations.Cor_Save_Name.Visible = 'on';
                    for j=1:numel(h.Mia_Image.Calculations.Cor_Block_Text)
                        h.Mia_Image.Calculations.Cor_Block_Text{j}.Visible = 'on';
                    end
                    h.Mia_Image.Calculations.Cor_Window.Visible = 'on';
                    h.Mia_Image.Calculations.Cor_Offset.Visible = 'on';
                    for j=1:numel(h.Mia_Image.Calculations.Cor_Local_Text)
                        h.Mia_Image.Calculations.Cor_Local_Text{j}.Visible = 'off';
                    end
                    h.Mia_Image.Calculations.Cor_Local_Size.Visible = 'off';
                    ...
                    h.Mia_Image.Calculations.Cor_Pseudo_Ilevels.Visible = 'off';
                case 5
                    %% pseudo-mapping RICS (Hendrix 2016)
                    h.Mia_Image.Calculations.Cor_Save_Name.Visible = 'on';
                    for j=1:numel(h.Mia_Image.Calculations.Cor_Block_Text)
                        h.Mia_Image.Calculations.Cor_Block_Text{j}.Visible = 'off';
                    end
                    ...
                    h.Mia_Image.Calculations.Cor_Local_Offset.Visible = 'off';
                    h.Mia_Image.Calculations.Cor_Local_NormF.Visible = 'off';
                    h.Mia_Image.Calculations.Cor_Local_D_Image.Visible = 'on';
                    h.Mia_Image.Calculations.Cor_Local_N_Image.Visible = 'on';
                    h.Mia_Image.Calculations.Cor_Pseudo_Ilevels.Visible = 'on';
                case {6,7}
                    %% small-ROI RICS (Longfils 2019)
                    h.Mia_Image.Calculations.Cor_Save_Name.Visible = 'on';
                    for j=1:numel(h.Mia_Image.Calculations.Cor_Block_Text)
                        h.Mia_Image.Calculations.Cor_Block_Text{j}.Visible = 'off';
                    end
                    ...
                    h.Mia_Image.Calculations.Cor_Offset.Visible = 'off';
                    for j=1:numel(h.Mia_Image.Calculations.Cor_Local_Text)
                        h.Mia_Image.Calculations.Cor_Local_Text{j}.Visible = 'on';
                    end
                    h.Mia_Image.Calculations.Cor_Local_Size.Visible = 'on';
                    h.Mia_Image.Calculations.Cor_Local_Offset.Visible = 'on';
                    h.Mia_Image.Calculations.Cor_Local_NormF.Visible = 'on';
                    h.Mia_Image.Calculations.Cor_Local_D_Image.Visible = 'on';
                    h.Mia_Image.Calculations.Cor_Local_N_Image.Visible = 'on';
                    h.Mia_Image.Calculations.Cor_Pseudo_Ilevels.Visible = 'off';
                otherwise
                    %% any other ICS analysis
                    h.Mia_Image.Calculations.Cor_Save_Name.Visible = 'on';
                    for j=1:numel(h.Mia_Image.Calculations.Cor_Block_Text)
                        h.Mia_Image.Calculations.Cor_Block_Text{j}.Visible = 'off';
                    end
...
if any(FileName~=0)
    ...
    if size(Image,3)==3       
        ...
        if numel(obj.AlphaData)>1 %%% When transparency is used to show unselected regions
            for i = 1:3
                Image(:,:,i) = Image(:,:,i).*obj.AlphaData + 255*(1-obj.AlphaData)*obj.Parent.Color(i);
            end
        end
    end
