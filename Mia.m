...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:2
        ...
        if ismac
            h.Mia_Image_Colormap(i).ForegroundColor = [0 0 0];
            h.Mia_Image_Colormap(i).BackgroundColor = [1 1 1];
        end
        %%% Text
        ...
        if ismac
            h.Mia_PIE(i).ForegroundColor = [0 0 0];
            h.Mia_PIE(i).BackgroundColor = [1 1 1];
        end
        ...
        if ismac
            h.Mia_Second(i).ForegroundColor = [0 0 0];
            h.Mia_Second(i).BackgroundColor = [1 1 1];
        end
...
if size(MIAData.Data,1)==1 && size(MIAData.Data,2)==2
    h.Mia_Mean_CR.String = {'Mean Countrate [kHz]:';...
                            [num2str(mean2(MIAData.Data{1,2})/str2double(h.Mia_Image_Pixel.String)*1e3) ' / -']};
elseif size(MIAData.Data,1)==2 && size(MIAData.Data,2)==2
    h.Mia_Mean_CR.String = {'Mean Countrate [kHz]:';...
                            [num2str(mean2(MIAData.Data{1,2})/str2double(h.Mia_Image_Pixel.String)*1e3) ' / '...
                             num2str(mean2(MIAData.Data{2,2})/str2double(h.Mia_Image_Pixel.String)*1e3)]};
else 
    h.Mia_Mean_CR.String = 'Mean Countrate [kHz]: - / -';
end
            ...
            if size(MIAData.Data,1)>=i
                ...
                switch h.Mia_Second(i).Value
                    case 1 %%% Uses ROI of original image
                        ...
                        elseif Frame==0
                            Frames = str2num(h.Mia_ROI_Frames.String); %#ok<ST2NM>
                            Image=mean(double(MIAData.Data{i,1}(From(2):To(2),From(1):To(1),Framew)),3);
                        end
        ...
        switch h.Mia_Additional.Plot_Popup(1,1).Value
            case 1 %%% Counts/Countrate
                ...
                if h.Mia_Additional.Axes(1).YLabel.UserData == 1;
                    h.Plots.Additional_Axes(1,1).YData = h.Plots.Additional_Axes(1,1).YData/str2double(h.Mia_Image_Pixel.String)*1000;
                    h.Mia_Additional.Axes(1).YLabel.String = 'Average Frames Countrate [kHz]';
                else
        ...
        switch h.Mia_Additional.Plot_Popup(2,1).Value
            case 1 %%% Counts/Countrate
                ...
                if h.Mia_Additional.Axes(2).YLabel.UserData == 1;
                    h.Plots.Additional_Axes(2,1).YData = h.Plots.Additional_Axes(2,1).YData/str2double(h.Mia_Image_Pixel.String)*1000;
    ...
    if isempty(MIAData.Data) || size(MIAData.Data,1)<2
        ...
        switch h.Mia_Additional.Plot_Popup(1,1).Value
            case 1 %%% Counts/Countrate
                ...
                if h.Mia_Additional.Axes(1).YLabel.UserData == 1;
                    h.Plots.Additional_Axes(1,2).YData = h.Plots.Additional_Axes(1,2).YData/str2double(h.Mia_Image_Pixel.String)*1000;
                end
            case 2 %%% Variance
        ...
        switch h.Mia_Additional.Plot_Popup(2,1).Value
            case 1 %%% Counts/Countrate
                ...
                if h.Mia_Additional.Axes(2).YLabel.UserData == 1;
                    h.Plots.Additional_Axes(2,2).YData = h.Plots.Additional_Axes(2,2).YData/str2double(h.Mia_Image_Pixel.String)*1000;
                end
            case 2 %%% Variance
...
if size(MIAData.Data,1)>0
    ...
    if str2double(h.Mia_Frame(1).String)>0
        h.Mia_FrameUse(1).Value=MIAData.Use(1,str2double(h.Mia_Frame(1).String));
    end
    if str2double(h.Mia_Frame(2).String)>0
