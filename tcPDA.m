...
if isempty(h)
    ...
    handles.file_menu = uimenu(handles.Figure,'Label','File');
    handles.load_button = uimenu(handles.file_menu,...
        'Label','Load *.tcpda file',...
        'Callback',@load_data,...
        'Tag','Load_Button');
    ...
    handles.checkbox_fix_stochasticlabeling = uicontrol('Parent',handles.tab_fit_table,...
        ...
        'Callback',@update_corrections);
    if UserValues.tcPDA.use_stochastic_labeling        
        set([handles.edit_stochasticlabeling, handles.checkbox_fix_stochasticlabeling],'Visible','on');
    end
    ...
    handles.FitMethod_popupmenu = uicontrol('Style','popupmenu',...
        ...
        'String',{'Simplex','Pattern Search','Gradient-based','Gradient-based (global)','Surrogate Optimization','Genetic Algorithm','Simulated Annealing','Particle Swarm'},...
    ...
    handles.checkbox_FixSigmaFractionR = uicontrol('Parent',handles.tab_fit_table,...
        'Style','checkbox',...
        'Tag','checkbox_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0.30 0.80 0.20 0.03],...
        'String','Sigma=f*R',...
        'BackgroundColor',UserValues.Look.Back,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...
        'Value',0,...
        'Callback',@update_corrections);
    handles.edit_FixSigmaFractionR = uicontrol('Parent',handles.tab_fit_table,...
        'Style','edit',...
        'Tag','edit_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0.05 0.80 0.1 0.03],...
        'BackgroundColor',UserValues.Look.Control,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...        
        'Visible','off',...
        'String',0.05,...
        'Callback',@update_corrections);
    handles.checkbox_fix_FixSigmaFractionR = uicontrol('Parent',handles.tab_fit_table,...
        'Style','checkbox',...
        'Tag','checkbox_fix_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0.15 0.80 0.075 0.03],...
        'String','F',...
        'BackgroundColor',UserValues.Look.Back,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...
        ...
        'Value',0,...
        'Callback',@update_corrections);
    handles.checkbox_global_FixSigmaFractionR = uicontrol('Parent',handles.tab_fit_table,...
        'Style','checkbox',...
        'Tag','checkbox_global_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0.225 0.80 0.075 0.03],...
        'String','G',...
        'BackgroundColor',UserValues.Look.Back,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...
    ...
    handles.text_FixSigmaFractionR_GR= uicontrol('Parent',handles.tab_fit_table,...
        'Style','text',...
        'Tag','checkbox_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0 0.794 0.05 0.03],...
        'String','GR',...
        'BackgroundColor',UserValues.Look.Back,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...
        ...
        'Visible','off',...
        'Callback',@update_corrections);    
    handles.text_FixSigmaFractionR_BG = uicontrol('Parent',handles.tab_fit_table,...
        'Style','text',...
        'Tag','checkbox_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0 0.754 0.05 0.03],...
        'String','BG',...
        'BackgroundColor',UserValues.Look.Back,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...
        ...
        'Visible','off',...
        'Callback',@update_corrections);
    handles.edit_FixSigmaFractionR_BG = uicontrol('Parent',handles.tab_fit_table,...
        'Style','edit',...
        'Tag','edit_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0.05 0.76 0.1 0.03],...
        'BackgroundColor',UserValues.Look.Control,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...      
        'Visible','off',...
        'String',0.05,...
        'Callback',@update_corrections);
    handles.checkbox_fix_FixSigmaFractionR_BG = uicontrol('Parent',handles.tab_fit_table,...
        'Style','checkbox',...
        'Tag','checkbox_fix_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0.15 0.76 0.1 0.03],...
        'String','F',...
        'BackgroundColor',UserValues.Look.Back,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...
        ...
        'Value',0,...
        'Callback',@update_corrections);
    handles.text_FixSigmaFractionR_BR = uicontrol('Parent',handles.tab_fit_table,...
        'Style','text',...
        'Tag','checkbox_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0 0.714 0.05 0.03],...
        'String','BR',...
        'BackgroundColor',UserValues.Look.Back,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...
        ...
        'Visible','off',...
        'Callback',@update_corrections);
    handles.edit_FixSigmaFractionR_BR = uicontrol('Parent',handles.tab_fit_table,...
        'Style','edit',...
        'Tag','edit_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0.05 0.72 0.1 0.03],...
        'BackgroundColor',UserValues.Look.Control,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...        
        'Visible','off',...
        'String',0.05,...
        'Callback',@update_corrections);
    handles.checkbox_fix_FixSigmaFractionR_BR = uicontrol('Parent',handles.tab_fit_table,...
        'Style','checkbox',...
        'Tag','checkbox_fix_FixSigmaFractionR',...
        'Units','normalized',...
        'Position',[0.15 0.72 0.1 0.03],...
        'String','F',...
        'BackgroundColor',UserValues.Look.Back,...
        'ForegroundColor',UserValues.Look.Fore,...
        'FontSize',10,...
...
switch hObject
    ...
    case handles.checkbox_stochasticlabeling
        ...
        if handles.checkbox_stochasticlabeling.Value == 1
            % disable dynamic model
            handles.dynamic_model_checkbox.Value = 0;
            %%% enable edit box    
            set([handles.edit_stochasticlabeling, handles.checkbox_fix_stochasticlabeling],'Visible','on');
        else
           %%% disable edit box 
            set([handles.edit_stochasticlabeling, handles.checkbox_fix_stochasticlabeling],'Visible','off');
        end
    ...
    case handles.dynamic_model_checkbox
        if handles.dynamic_model_checkbox.Value == 1
            % disable stochastic labeling        
            handles.checkbox_stochasticlabeling.Value = 0;            
        end
        % rest plot
        reset_plot([],[],handles);
...
if include_width
    ...
    if ~all_combinations        
        ...
        % opposite, i.e. always +- (worse than just +)
        % combinations(:,:,2) = (-1)*combinations(:,:,2); 
        
        % combination of both (++ and +-) performs best!
        % -> add opposite combinations to array
        temp = combinations; temp(:,:,2) = (-1)*temp(:,:,2);
...
for i = 1:size(combinations,1)
    ...
    for j = 1:2
        [Qr_g(j),Qr_b(j)] = calc_relative_brightness(Rgr_mod(j),Rbg_mod(j),Rbr_mod(j));
    end
