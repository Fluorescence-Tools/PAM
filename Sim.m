...
for i=1:4
    ...
    h.Text_Color{i} = uicontrol(...
        ...
        'Position',[0.27 0.68-0.06*i 0.09 0.05]);
    %%% Brightness 
    h.Sim_Brightness{i} = uicontrol(...
        ...
        'String','1000',...
        'Callback',@Sim_Settings,...
        'Position',[0.4 0.68-0.06*i 0.09 0.05]);
    ...
    h.Sim_Bleaching{i} = uicontrol(...
        ...
        'String','0',...
        'Callback',@Sim_Settings,...
        'Position',[0.55 0.68-0.06*i 0.09 0.05]);
    %%% Focus size lateral
    h.Sim_wr{i} = uicontrol(...
        ...
        'String','200',...
        'Callback',@Sim_Settings,...
        'Position',[0.7 0.68-0.06*i 0.09 0.05]);
    %%% Focus size axial
    h.Sim_wz{i} = uicontrol(...
        ...
        'String','1000',...
        'Callback',@Sim_Settings,...
        'Position',[0.85 0.68-0.06*i 0.09 0.05]);
end
...
for i = 1:numel(SimData.Species);
    ...
    for j = 1:SimData.Species(i).Color
        ...
        BP(j) = SimData.Species(1).Bleaching(j);
    end
    ...
    for j = 1:NoP
        ...
        [Photons1, Photons2, Photons3, Photons4, ~, ~, ~] = DifSim(...
            ...
            wr(2), wz(2),MB(2),BP(2),... %%% Second color
            wr(3), wz(3),MB(3),BP(3),... %%% Third color
            wr(4), wz(4),MB(4),BP(4));   %%% Forth color   
