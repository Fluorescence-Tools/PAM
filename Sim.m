...
%%% Extra Parameters for Nanopore Simulation
h.Text_NanoporeDiameter = uicontrol(...
    'Parent',h.Sim_Species_Panel,...
    'Units','normalized',...
    'FontSize',12,...
    'Style','text',... 
    ...
    'String','Diam. [nm]',...
    'Visible','off',...
    'Position',[0.79 0.8 0.07 0.08]);
h.Sim_NanoporeDiameter = uicontrol(...
    'Parent',h.Sim_Species_Panel,...
    'Units','normalized',...
    'FontSize',12,...
    'Style','edit',...
    ...
    'Visible','off',...
    'Callback',@Sim_Settings,...
    'Position',[0.79 0.72 0.07 0.08]);
h.Text_NanoporeThickness = uicontrol(...
    'Parent',h.Sim_Species_Panel,...
    'Units','normalized',...
    'FontSize',12,...
    'Style','text',... 
    ...
    'String','Thick. [nm]',...
    'Visible','off',...
    'Position',[0.86 0.8 0.07 0.08]);
h.Sim_NanoporeThickness = uicontrol(...
    'Parent',h.Sim_Species_Panel,...
    'Units','normalized',...
    'FontSize',12,...
    'Style','edit',...
    ...
    'Visible','off',...
    'Callback',@Sim_Settings,...
    'Position',[0.86 0.72 0.07 0.08]);
h.Text_NanoporePenetration = uicontrol(...
    'Parent',h.Sim_Species_Panel,...
    'Units','normalized',...
    'FontSize',12,...
    'Style','text',... 
    ...
    'String','Pen. [nm]',...
    'Visible','off',...
    'Position',[0.93 0.8 0.07 0.08]);
h.Sim_NanoporePenetration = uicontrol(...
    'Parent',h.Sim_Species_Panel,...
    'Units','normalized',...
    'FontSize',12,...
    'Style','edit',...
...
for i=1:4
    ...
    %%% relative diffusion in pore for nanopore model
    h.Text_Nanopore_RelativeDiffusion = uicontrol(...
        'Parent',h.Sim_Species_Panel,...
        'Units','normalized',...
        'FontSize',12,...
        'Style','text',...
        ...
        'BackgroundColor', Look.Back,...
        'ForegroundColor', Look.Fore,...
        'String','D rel in pore [%]:',...
        'Visible','off',...
        'Position',[0.42 0.04 0.12 0.08]);
    h.Sim_Nanopore_RelativeDiffusion = uicontrol(...
        'Parent',h.Sim_Species_Panel,...
        'Units','normalized',...
        'FontSize',12,...
        'Style','edit',...
...
switch Obj   
    ...
    case h.Sim_Barrier %%% Defines type of barrieres to be simulated
        ...
        if strcmp(h.Sim_Barrier.String{h.Sim_Barrier.Value},'Nanopore')
            %%% unhide components
            set([h.Text_NanoporePenetration,h.Sim_NanoporePenetration,...
                 h.Text_NanoporeThickness,h.Sim_NanoporeThickness,...
                 h.Text_NanoporeDiameter,h.Sim_NanoporeDiameter,...
                 h.Text_Nanopore_RelativeDiffusion,h.Sim_Nanopore_RelativeDiffusion],...
                 'Visible','on');
        else
            % hide
            set([h.Text_NanoporePenetration,h.Sim_NanoporePenetration,...
    ...
    case h.Sim_NanoporePenetration
        SimData.Species(Sel).NanoporePenetration = str2double(h.Sim_NanoporePenetration.String);
    case h.Sim_NanoporeThickness    
        SimData.Species(Sel).NanoporeThickness = str2double(h.Sim_NanoporeThickness.String);
    case h.Sim_NanoporeDiameter
        SimData.Species(Sel).NanoporeDiameter = str2double(h.Sim_NanoporeDiameter.String);
    case h.Sim_Nanopore_RelativeDiffusion
        relD = str2double(h.Sim_Nanopore_RelativeDiffusion.String);
        if relD < 1
            relD = 1;
        elseif relD > 100
            relD = 100;
        end
        SimData.Species(Sel).RelativePoreDiffusion = relD;
            ...
            case {2,3,4,5,8,9} %%% Static Maps
                if isfield(SimData,'Map') && iscell(SimData.Map)
                    ...
                    elseif Map_Type == 9 % Special case - Nanopore
                        pore_diffusion = SimData.Species(i).RelativePoreDiffusion/100; % Relative diffusion coefficient in the pore D_pore/D0
                        pore_thickness = SimData.Species(i).NanoporeThickness; % pore thickness in nanometers
                        pore_radius = SimData.Species(i).NanoporeDiameter/2; % pore radius in nanometers
                        pore_penetration = SimData.Species(i).NanoporePenetration;
                    end
                else
                    Map_Type = 1;
                    if ~isfield(SimData,'Map') || ~iscell(SimData.Map)
            ...
            for k=1:Frames 
                ...
                if Map_Type ~= 9                
                    ...
                    [Photons,  MI, Channel, Pos] = DifSim_Nanopore(...
                        ...
                        FRET, Cross,... %%% Relative FRET and Crosstalk rates
                        uint32(seed+k+j),...%%% Uses seed, frame and particle to have more precision of the random seed (second resolution)
                        Map_Type, pore_diffusion,...  %%% Type of barriers/quenching and barrier map
                        pore_thickness, pore_radius, pore_penetration);  %%% The nanopore parameters
                end
