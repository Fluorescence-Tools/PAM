function [rpi,reg_c,rho_c,eta_c] = l_corner(rho,eta,reg_param,U,s,b,method,M)
...
if 0  % Show log-log L-curve and indicate the found corner.
    figure; clf
    index = rpi;
    ...
    title(sprintf('L-curve, corner at \\mu = %.2d', reg_param(index)));
