...
%%% Modified to find the corner of the chi2 vs. mu curve instead!
%%% Anders, 21.4.2020
...
vz = find(-diff(P(clist,2)) ...  % Points where the decrease in residual
     >= abs(diff(P(clist,1)))); % norm is larger than or equal
