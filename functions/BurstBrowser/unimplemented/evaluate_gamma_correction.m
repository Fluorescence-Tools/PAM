...
scatter(mE,w_res_S,'filled','MarkerFaceColor',colors(2,:));
plot([-0.2,1.2],[0,0],'--k','LineWidth',1.5);
...
plot([-0.2,2.2],[0.5,0.5],'LineWidth',1.5);
...
scatter(mTau,w_res_E,'filled','MarkerFaceColor',colors(2,:));
