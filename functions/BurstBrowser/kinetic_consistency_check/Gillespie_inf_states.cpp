...
using namespace std;
// using namespace tr1;
void Simulate_States(double * SimTime, const int n_states, double *dwell_mean, const int time_windows, double *time_in_states, double *p_eq, double *k_dyn)        
{
