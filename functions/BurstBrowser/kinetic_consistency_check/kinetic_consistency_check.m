...
%         end
%         dwell_mean = 1 ./ sum(rate_matrix) * 1000;
%         for i = 1:n_states
...
%         p_eq = rate_matrix\b;
%         if n_states == 3
%             FracT = Gillespie_inf_states(dur,n_states,dwell_mean,numel(dur),p_eq,change_prob);
%         else
%             FracT = Gillespie_2states(dur,dwell_mean,numel(dur),p_eq);
%         end
