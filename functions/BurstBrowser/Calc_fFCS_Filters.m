...
if use_species3
    Decay_par = [Decay_par,BurstMeta.fFCS.hist_MIpar_Species{3}];
end
...
if isMFD
    ...
    if use_species3
        Decay_perp = [Decay_perp,BurstMeta.fFCS.hist_MIperp_Species{3}];
    end
    if isfield(BurstData{file},'ScatterPattern') && UserValues.BurstBrowser.Settings.fFCS_UseIRF %%% include scatter pattern
...
if use_species3
    BurstMeta.Plots.fFCS.FilterPar_Species3.Visible = 'on';
    BurstMeta.Plots.fFCS.FilterPar_Species3.XData = BurstMeta.fFCS.TAC_par;
    BurstMeta.Plots.fFCS.FilterPar_Species3.YData = BurstMeta.fFCS.filters_par(3,:);
else
    BurstMeta.Plots.fFCS.FilterPar_Species3.Visible = 'off';
end
if size(BurstMeta.fFCS.filters_par,1) > (2+use_species3)
    BurstMeta.Plots.fFCS.FilterPar_IRF.Visible = 'on';
    BurstMeta.Plots.fFCS.FilterPar_IRF.XData = BurstMeta.fFCS.TAC_par;
    BurstMeta.Plots.fFCS.FilterPar_IRF.YData = BurstMeta.fFCS.filters_par(3+use_species3,:);
else
    BurstMeta.Plots.fFCS.FilterPar_IRF.Visible = 'off';
end
if size(BurstMeta.fFCS.filters_par,1) > (3+use_species3)
    BurstMeta.Plots.fFCS.FilterPar_DOnly.Visible = 'on';
    BurstMeta.Plots.fFCS.FilterPar_DOnly.XData = BurstMeta.fFCS.TAC_par;
    BurstMeta.Plots.fFCS.FilterPar_DOnly.YData = BurstMeta.fFCS.filters_par(4+use_species3,:);
else
...
if isMFD
    ...
    if use_species3
        BurstMeta.Plots.fFCS.FilterPerp_Species3.Visible = 'on';
        BurstMeta.Plots.fFCS.FilterPerp_Species3.XData = BurstMeta.fFCS.TAC_perp;
        BurstMeta.Plots.fFCS.FilterPerp_Species3.YData = BurstMeta.fFCS.filters_perp(3,:);
    else
        BurstMeta.Plots.fFCS.FilterPerp_Species3.Visible = 'off';
    end
    if size(BurstMeta.fFCS.filters_perp,1) > (2+use_species3)
        BurstMeta.Plots.fFCS.FilterPerp_IRF.Visible = 'on';
        BurstMeta.Plots.fFCS.FilterPerp_IRF.XData = BurstMeta.fFCS.TAC_perp;
        BurstMeta.Plots.fFCS.FilterPerp_IRF.YData = BurstMeta.fFCS.filters_perp(3+use_species3,:);
    else
        BurstMeta.Plots.fFCS.FilterPerp_IRF.Visible = 'off';
    end
    if size(BurstMeta.fFCS.filters_perp,1) > (3+use_species3)
        BurstMeta.Plots.fFCS.FilterPerp_DOnly.Visible = 'on';
        BurstMeta.Plots.fFCS.FilterPerp_DOnly.XData = BurstMeta.fFCS.TAC_perp;
        BurstMeta.Plots.fFCS.FilterPerp_DOnly.YData = BurstMeta.fFCS.filters_perp(4+use_species3,:);
    else
