...
{    
    if(nrhs!=14)
    { mexErrMsgIdAndTxt("dyn_Sim:nrhs","14 inputs required."); }
    if (nlhs!=1)
    ...
    Simulate_States(mBG_gg, mBG_gr, R, sigmaR, R0, cr, de, ct, gamma, time_windows, SimTime, BSD, dwell_mean, p_eq, PRH);
