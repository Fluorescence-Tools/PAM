...
void Simulate_Diffusion(__int64_t SimTime, const int n_states, double *k_dyn, double *initial_state, __int64_t *time_in_state1, __int64_t seed, __int64_t time_windows)        
{
    ...
    for (tw=0;tw<time_windows;tw++){
        ...
        for (i=0; i<SimTime; i++){    
            ...
            time_in_state1[tw] += (__int64_t) state;
        }
...
{    
    ...
    __int64_t *time_in_state1 = (__int64_t*) mxCalloc(4*time_windows, sizeof(__int64_t));   
