...
h.Look_Text = uicontrol(...
    ...
    'String',Look.Font);
h.Look_AxWidth = uicontrol(...
    'Parent',h.Look_Panel,...
    'Units','normalized',...
    'Position',[0.6 0.14 0.03 0.05],...
    'BackgroundColor', Look.Control,...
    'ForegroundColor', Look.Fore,...
    'FontSize',16,...
    'Style', 'edit',...
    'Enable','on',...
    'Callback',{@Change_Look,14},...
    'String',num2str(Look.AxWidth));
h.Look_AxWidth = uicontrol(...
    'Parent',h.Look_Panel,...
    'Units','normalized',...
    'Position',[0.5 0.11 0.10 0.07],...
    'BackgroundColor', Look.Back,...
    'ForegroundColor', Look.Fore,...
    'FontSize',16,...
    'Style', 'text',...
    'Enable','on',...
    'String','Axes LineWidth:');
%% Saves handles
guidata(h.Look,h);  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Functions change the color properties of pam windows %%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
switch mode
    ...
    case 14
        UserValues.Look.AxWidth = str2num(Obj.String);
end
LSUserValues(1);
