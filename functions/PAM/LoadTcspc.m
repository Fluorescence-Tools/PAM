...
switch (Type)
    ...
    case {4} %%4 : *.ht3 files from FabSurf
        %%% Usually, here no Imaging Information is needed
        ...
        FileInfo.NumberOfFiles=numel(FileName);
        FileInfo.Type=Type;
        FileInfo.ImageTimes=FileInfo.Fabsurf.ImageTimes/1000;
    ...
    case 7 %%% .PTU files from HydraHarp Software V3.0
        %%% Usually, here no Imaging Information is needed
        FileInfo.FileType = 'HydraHarp';
        %%% General FileInfo
        FileInfo.NumberOfFiles=numel(FileName);
        ...
        FileInfo.Lines=size(FileInfo.LineTimes,2)-1;
        FileInfo.Pixels=FileInfo.Lines;
    case 8 %%% .h5 files in PhotonHDF5 file format
    ...
    case 9 %%% *.t3r TTTR files from TimeHarp 200
        %%% Usually, here no Imaging Information is needed
