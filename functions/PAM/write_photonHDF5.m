...
switch UserValues.BurstSearch.Method
    case {1,2} % 2color MFD with polarization
        %% Setup description
        num_pixels =           4;
        num_spots =            1;
        ...
        fprintf(fileID,formatSpec,timestamps_unit,tcsp_unit,tcspc_num_bins,tcspc_range,...
                ...
                alex_excitation_period2(1),alex_excitation_period1(2),...
        ...
        clear idx
    case 5 % 2color PIE, no polarization
        %% Setup description
        num_pixels =           2;
        num_spots =            1;
        ...
        fprintf(fileID,formatSpec,timestamps_unit,tcsp_unit,tcspc_num_bins,tcspc_range,...
                measurement_type,laser_repetition_rate,alex_excitation_period1(1),...
                alex_excitation_period2(1),alex_excitation_period1(2),...
                alex_excitation_period2(2),spectral_ch1,spectral_ch2);
        ...
        % map burst search selection to PIE channels
        chan(1) = find(strcmp(UserValues.PIE.Name,UserValues.BurstSearch.PIEChannelSelection{UserValues.BurstSearch.Method}(1,1)));
        chan(2) = find(strcmp(UserValues.PIE.Name,UserValues.BurstSearch.PIEChannelSelection{UserValues.BurstSearch.Method}(3,1)));
...
if exist(filename,'file') == 2 %%% file already exists -> delete
    delete(filename);
end
