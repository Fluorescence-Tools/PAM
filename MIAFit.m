...
[FileName,PathName,Type] = uigetfile({'*.miacor'; '.miatif'; '.tif'}, 'Choose an image data file', UserValues.File.MIAFitPath, 'MultiSelect', 'on');
...
switch Type
    ...
    case 2 %% MIA correlation file based on .tif + info file (.miat)
end
