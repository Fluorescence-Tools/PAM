...
%         'Callback',@Load_Photons);
    ...
    h.KineticTableStates_text = uicontrol(...
        'Parent',h.ConsistencyAnalysis,...
        'Units','normalized',...
        'BackgroundColor', Look.Back,...
        'ForegroundColor', Look.Fore,...
        ...
        'String','States',...
        'HorizontalAlignment','left',...
        'TooltipString','Number of states for kinetic table.',...
        'FontSize',12);
    
    h.BVA_Nstates_Popupmenu = uicontrol('Style','popup',...
        'Units','normalized',...
        'Callback',@UpdateBVATab,...
        'Position',[0.15,0.8,0.15,0.08],...
        'String',{'2','3'},...
        'Parent',h.ConsistencyAnalysis,...
        'FontSize',12,...
        'TooltipStr','Number of states.');
