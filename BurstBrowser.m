...
%         'Callback',@Load_Photons);
    ...
    h.BinNumber_edit = uicontrol(...
        ...
        'Style','edit',...
        'Tag','BinNumber_edit',...
        'String',UserValues.BurstBrowser.Settings.NumberOfBins_BVA,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.BurstsPerBin_edit = uicontrol(...
        ...
        'String',UserValues.BurstBrowser.Settings.BurstsPerBinThreshold_BVA,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.ConfidenceInterval_edit = uicontrol(...
        ...
        'String',UserValues.BurstBrowser.Settings.ConfidenceSampling_BVA,...
        'HorizontalAlignment','left',...
        'TooltipString','Sampling number used for calculating confidence intervals. If 0 is entered, confidence intervals will not be calculated.',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.PhotonsPerWindow_edit = uicontrol(...
        ...
        'String',UserValues.BurstBrowser.Settings.PhotonsPerWindow_BVA,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
...
for i = 1:size(UserValues.BurstBrowser.Settings.BVA_KineticRatesTable3,2)
    ...
    h.Rsigma1_edit = uicontrol(...
        ...
        'Style','edit',...
        'Tag','Rsigma1_edit',...
        'String',UserValues.BurstBrowser.Settings.BVA_Rsigma1,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.Rstate2_edit = uicontrol(...
        ...
        'Style','edit',...
        'Tag','Rstate2_edit',...
        'String',UserValues.BurstBrowser.Settings.BVA_R2,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.Rsigma2_edit = uicontrol(...
        ...
        'Style','edit',...
        'Tag','Rsigma2_edit',...
        'String',UserValues.BurstBrowser.Settings.BVA_Rsigma2,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.Rsigma3_edit = uicontrol(...
        ...
        'Style','edit',...
        'Tag','Rsigma3_edit',...
        'String',UserValues.BurstBrowser.Settings.BVA_Rsigma3,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Visible','off',...
        'Callback',@UpdateBVATab);
    ...
    h.Rstate1st_edit = uicontrol(...
        ...
        'String',UserValues.BurstBrowser.Settings.BVA_R1_static,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.Rsigma1st_edit = uicontrol(...
        ...
        'String',UserValues.BurstBrowser.Settings.BVA_Rsigma1_static,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.Rstate2st_edit = uicontrol(...
        ...
        'String',UserValues.BurstBrowser.Settings.BVA_R2_static,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.Rsigma2st_edit = uicontrol(...
        ...
        'String',UserValues.BurstBrowser.Settings.BVA_Rsigma2_static,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Callback',@UpdateBVATab);
    ...
    h.Rstate3st_edit = uicontrol(...
        ...
        'String',UserValues.BurstBrowser.Settings.BVA_R3_static,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Visible','off',...
        'Callback',@UpdateBVATab);
    ...
    h.Rsigma3st_edit = uicontrol(...
        ...
        'Style','edit',...
        'Tag','Rsigma1stat_edit',...
        'String',UserValues.BurstBrowser.Settings.BVA_Rsigma3_static,...
        'HorizontalAlignment','left',...
        'FontSize',12,...
        'Visible','off',...
        'Callback',@UpdateBVATab);
