...
% 2020 - FAB Lab Munich - Don C. Lamb
...
if isempty(hfig)
    ...
    h.Merge_Files_Menu = uimenu(...
        ...
        'Separator','on');
    %%% Merge *.bur files
    h.Merge_Files_From_Folder_Menu = uimenu(...
        'Parent',h.File_Menu,...
        'Label','<html><b>Merge</b> <i>*.bur</i>-files from <b>Subfolders</b></html>',...
        'Callback',@Merge_bur_files,...
        'Tag','Merge_Files_From_Folder_Menu',...
        'Separator','off');
    %%% Export to CVS file
    ...
    h.Export_Menu = uimenu(...
        ...
        'Enable','on');
    %%% Open a new powerpoint report
    h.Export_Report_Menu = uimenu(...
        'Parent',h.Export_Menu,...
        'Label','<html>Open <i>PowerPoint</i> file for Report Generation</html>',...
        'Callback',{@report_generator,1},...
        'Tag','Export_Report_Menu',...
        'Separator','off');
    h.Export_ReportAdd_Menu = uimenu(...
        'Parent',h.Export_Menu,...
        'Label','<html>Add current view to report <b>(Ctrl+P)</b></html>',...
        'Callback',{@report_generator,2},...
        'Tag','Export_ReportAdd_Menu',...
        'Enable','off',...
        'Separator','off');
    h.Export_ReportClose_Menu = uimenu(...
        'Parent',h.Export_Menu,...
        'Label','<html>Close and view current report</html>',...
        'Callback',{@report_generator,3},...
        'Tag','Export_ReportClose_Menu',...
        'Enable','off',...
        'Separator','off');
    ...
    h.Export_Seidel_Bursts=uimenu(...
        'Parent',h.Extras_Menu,...
        'Label','<html>Export as <b>Seidel</b> Burst Data to Margerita software</html>',...
        'Callback',@Export_Seidel_Burst_Data,...
        'Separator','off',...
        'Tag','Export_Seidel_Bursts');
    h.SaveBID_for_Seidel = uimenu(...
        'Parent',h.Extras_Menu,...
        'Label','<html>Save <b>Burst IDs</b> for use in Seidel software</html>',...
        'Callback',@Save_BurstIDs,...
        'Separator','off',...
        'Tag','Load_Seidel_Bursts');
    h.Dog_Mode = uimenu(...
        'Parent',h.Extras_Menu,...
...
%         'ForegroundColor',Look.Fore);
    ...
    h.FitGammaFromPhotonCounts = uimenu(...
        ...
        'Tag','FitGammaFromPhotonCounts',...
        'Callback',@DetermineCorrections);
    h.FitGammaFromPhotonCountsBetaFixed = uimenu(...
        'Parent',h.Menu_gammadetermination,...
        'Label','<html>Fit gamma-factor using photon counts (beta fixed)</html>',...%'ToolTipString','<html>Fits the &gamma;-factor by minimizing the Kullback-Leibler divergence<br>between the stoichiometry distributins of two species.</html>',...
        'Tag','FitGammaFromPhotonCountsBetaFixed',...
        'Callback',@DetermineCorrections);
    ...
    h.DynamicFRETArbitrary_Menu = uimenu(...
        'Parent',h.DynamicFRET_Menu,...
        'Tag','DynamicFRETArbitrary_Menu',...
        'Callback',@UpdateLifetimeFits,...
        'Label','Dynamic FRET line (arbitrary)');
    h.DynamicFRETManual_Menu = uimenu(...
        ...
        'Label','Define States',...
        'Separator','on');
    h.DynamicFRETManualSigma_Menu = uimenu(...
        'Parent',h.DynamicFRET_Menu,...
        'Tag','DynamicFRETManualSigma_Menu',...
        'Callback',@UpdateLifetimeFits,...
        'Label','Define States (with sigma)');
    ...
    h.Secondary_Tab_Correlation_Reset_Menu = uimenu(...
        ...
        'Callback',@Calculate_Settings);
    %%% toggles afterpulsing correction of autocorrelation curves
    h.Secondary_Tab_Correlation_Afterpulsing_Menu = uimenu(...
        'Parent',h.Secondary_Tab_Correlation_Menu,...
        'Label','Afterpulsing correction',...
    ...
    h.Correlate_Menu = uicontextmenu;
    h.FullCorrelation_Menu = uimenu(...
        'Parent',h.Correlate_Menu,...
        'Label','full-FCS',...
        'Callback',@Correlate_Bursts);
    h.Burstwise_nsFCS_linear_Menu = uimenu(...
        'Parent',h.Correlate_Menu,...
        'Label','nsFCS (linear)',...
        'Callback',@Correlate_Bursts);
    h.Correlate_Button = uicontrol(...
        ...
        'FontSize',fontsize_normal,...
        'Callback',@Correlate_Bursts,...
        'UIContextMenu',h.Correlate_Menu);
...
%         'Callback',@Load_Photons);
    ...
    h.SignificanceLevelAlpha_text = uicontrol(...
        'Parent',h.DynamicAnalysis,...
        'Units','normalized',...
        'BackgroundColor', Look.Back,...
        'ForegroundColor', Look.Fore,...
        'Position',[0.4 0.6 0.07 0.07],...
        'Style','text',...
        'Tag','SignifanceLevelAlpha_text',...
        'String','α',...
        'HorizontalAlignment','left',...
        'TooltipString','The significance level α determines the probability of a false positive with respect to dynamics beeing present.',...
        'FontSize',fontsize_normal,...
        'Callback',@UpdateBVATab);
    
    h.SignificanceLevelAlpha_edit = uicontrol(...
        'Parent',h.DynamicAnalysis,...
        'Units','normalized',...
        'BackgroundColor', Look.Control,...
        'ForegroundColor', Look.Fore,...
        'Position',[0.42 0.6 0.07 0.07],...
        'Style','edit',...
        'Tag','SignifanceLevelAlpha_edit',...
        'String',num2str(UserValues.BurstBrowser.Settings.ConfidenceLevelAlpha_BVA),...
        'HorizontalAlignment','left',...
        'TooltipString','The significance level α determines the probability of a false positive with respect to dynamics beeing present.',...
        'FontSize',fontsize_normal,...
        'Callback',@UpdateBVATab);
    ...
    h.KineticRates_table2 = uitable(...
        ...
        'Position',[0.05 0.195 0.45 0.155]);
    ...
    Colormaps_String = {'jet','parula','spectral','batlow','roma','hot','gray','redblue','lapaz','vik',... % standard maps for BurstBrowser
    ...
    h.TimeBin_TimeWindow_Text = uicontrol('Style','text',...
        'Parent',h.DataProcessingPanel,...
        'String','Timebins for Time Window Analysis [ms]',...
        'Tag','TimeBin_TimeWindow_Text',...
        'Units','normalized',...
    ...
    h.TimeBin_TimeWindow_Edit = uicontrol(...
        'Style','edit',...
        'Parent',h.DataProcessingPanel,...
        'BackgroundColor', Look.Control,...
        'ForegroundColor', Look.Fore,...
        ...
        'FontSize',fontsize_normal,...
        'Tag','TimeBin_TimeWindow_Edit',...
        'String',UserValues.BurstBrowser.Settings.TimeWindow_TimeBin,...
        'Callback',@UpdateOptions,...
        'TooltipString', 'e.g. "0.2, 0.5, 0.75, 1"'...
        );
