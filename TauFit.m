...
if h.FitPar_Table.Data{end,4} == 0
    ...
    irf_ub = h.FitPar_Table.Data{end,3}; %Anders, see what I changed in the next line. is that ok?
    shift_range = irf_lb:irf_ub; %floor(TauFitData.IRFShift{chan} + irf_lb):ceil(TauFitData.IRFShift{chan} + irf_ub);
