...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    h.Burst.SubPanel_BurstSearch = uibuttongroup(...
        ...
        'HighlightColor', Look.Control,...
        'ShadowColor', Look.Shadow,...
        'Position',[0.375 0.55 .375 .45]);
    %%% Axes for preview of Burst Selection
    h.Burst.Axes = axes(...
       'Parent',h.Burst.MainPanel,...
       'Tag','Burst_Axes',...
       'Position',[0.07 0.06 0.92 0.4],...
       'Units','normalized',...
       'NextPlot','add',...
       'XColor',Look.Fore,...
       'YColor',Look.Fore,...
    ...
    switch UserValues.BurstSearch.SaveTotalPhotonStream
        case 0
            h.Burst.SaveTotalPhotonStream_Checkbox.Value = 0;
        case 1
            h.Burst.SaveTotalPhotonStream_Checkbox.Value = 1;
    end
