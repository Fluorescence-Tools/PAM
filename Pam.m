...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    h.MI.Settings_Tab= uitab(...
        'Parent',h.Det_Tabs,...
        'Tag','MI_Settings_Tab',...
        'Title','Settings');
    %%% Microtime settings panel
    h.MI.Settings_Panel = uibuttongroup(...
        'Parent',h.MI.Settings_Tab,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   h.Burst.Axes = axes(...
       ...
       'YColor',Look.Fore,...
       'Box','on');
    h.Burst.Axes.XLabel.String='Time [ms]';
    h.Burst.Axes.XLabel.Color=Look.Fore;
    h.Burst.Axes.YLabel.String='Counts per Timebin';
    h.Burst.Axes.YLabel.Color=Look.Fore;
    h.Burst.Axes.XLim=[0 1];
    ...
    h.Burst.Button_Menu_SaveTotalPhotonStream = uimenu(h.Burst.Button_Menu,...
        'Label','Save Total Photons Stream for correlation analysis',...
        'Callback',@Calculate_Settings);
    switch UserValues.BurstSearch.SaveTotalPhotonStream
        case 0
            h.Burst.Button_Menu_SaveTotalPhotonStream.Checked = 'off';
        case 1
            h.Burst.Button_Menu_SaveTotalPhotonStream.Checked = 'on';
    end
    ...
    h.Profiles.Description = uicontrol(...
        'Parent',h.Profiles.Panel,...
        'Style','edit',...
        'Units','normalized',...
        'FontSize',12,...
...
elseif obj == h.MI.ScatterPattern
    ...
    Update_Display([],[],8);
elseif obj == h.Burst.Button_Menu_SaveTotalPhotonStream
...
if obj ==  h.BurstSearchPreview_Button %%% recalculate the preview
    ...
    for i=first:last
        h.Plots.BurstPreview.SearchResult.Channel1(i) = plot(h.Burst.Axes, PamMeta.Burst.Preview.x(starttime(i):stoptime(i)),ch1(starttime(i):stoptime(i)),'og');
        h.Plots.BurstPreview.SearchResult.Channel2(i) = plot(h.Burst.Axes, PamMeta.Burst.Preview.x(starttime(i):stoptime(i)),ch2(starttime(i):stoptime(i)),'or');
        if any(BAMethod == [3 4])
            h.Plots.BurstPreview.SearchResult.Channel3(i) = plot(h.Burst.Axes, PamMeta.Burst.Preview.x(starttime(i):stoptime(i)),ch3(starttime(i):stoptime(i)),'ob');
        end
    end
    guidata(findobj('Tag','Pam'),h);
else %%% < or > was pressed
    ...
    h.Burst.Axes.XLim = [PamMeta.Burst.Preview.Second  PamMeta.Burst.Preview.Second+1];
end
%%% Update Display
Update_Display([],[],1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
