    ...
    switch Type
        ...
        case 'open' %%% Copies whole axes to new figure
            ...
            for i=1:numel(a)
                ...
                if strcmp(get(copy,'Type'),'image')
                    uistack(copy,'bottom');
                end
                %%% Makes all objects clickable
                set(copy,'hittest','on');
                %%% Puts all new objects on top
                set(p,'Layer','top');
            end
            %%% Sets axes to full range
            set(p,'DataAspectRatio',[1 1 1],...
                'YLim', [0 0.51],...
                'XLim', [-0.05 1.05]);
    end
elseif Key>0 && Key <=6
...
if Main 
    ...
    if h.Main_Tab.SelectedTab~=h.Plots_Tab && numel(PhasorData.Data)>0
