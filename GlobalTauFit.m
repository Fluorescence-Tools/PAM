...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% menu
h.Menu.File = uimenu(h.GlobalTauFit,'Label','File');
...
h.Menu.OpenDecayDOnlyData_PQ = uimenu(h.Menu.File,'Label','Load PQ DOnly data (*.dat)',...
    'Callback',@Load_Data,'Enable','off');
h.Menu.Export_Menu = uimenu(h.GlobalTauFit,'Label','Export...');
...
[h.FitPar_Table.Data, h.FitPar_Table.ColumnName, Tooltip] = GetTableData(1, 1);
try
...
if exist('bh','var')
    if bh.SendToTauFit.equals(obj) || obj == bh.Send_to_TauFit_Button
        ...
        if any(TauData.BAMethod == [1,2])
            ...
            h.Menu.Extra_Menu = uimenu(h.GlobalTauFit,'Label','Extra...');
...
if strcmp(UserValues.TauFit.PIEChannelSelection{1},UserValues.TauFit.PIEChannelSelection{2})
    ...
    [h.FitPar_Table.Data, h.FitPar_Table.ColumnName, Tooltip] = GetTableData(h.FitMethod_Popupmenu.Value, chan);
    try
        h.FitPar_Table.TooltipString = Tooltip;
    catch %%% in newer version, this is now just called "Tooltip"
        h.FitPar_Table.Tooltip = Tooltip;
...
if isprop(obj,'Style')
    switch obj.Style
        case 'slider'
            ...
            h.FitPar_Table.Data{:,end-3} = TauFitData.IRFShift{chan};
...
[h.FitPar_Table.Data, h.FitPar_Table.ColumnName, Tooltip] = GetTableData(obj.Value, chan);
try
    h.FitPar_Table.TooltipString = Tooltip;
catch %%% in newer version, this is now just called "Tooltip"
    h.FitPar_Table.Tooltip = Tooltip;
...
switch obj
    case {h.Fit_Button}
        ...
        TauFitData.FitType = h.FitMethod_Popupmenu.String{h.FitMethod_Popupmenu.Value};
        %%% Read out parameters
        x0 = cell2mat(h.FitPar_Table.Data(:,1:4:end));
        lb = cell2mat(h.FitPar_Table.Data(:,2:4:end));
        ub = cell2mat(h.FitPar_Table.Data(:,3:4:end));
        fixed = cell2mat(h.FitPar_Table.Data(:,4:4:end));
        ...
        switch TauFitData.FitType
            case 'Single Exponential'
                ...
                h.FitPar_Table.Data(:,1:4:end) = FitResult;
                fix = cell2mat(h.FitPar_Table.Data(1,4:4:end));
                if save_fix
        ...
        if any(strcmp(TauFitData.FitType,{'Fit Anisotropy','Fit Anisotropy (2 exp rot)','Fit Anisotropy (2 exp lifetime)','Fit Anisotropy (2 exp lifetime, 2 exp rot)','Fit Anisotropy (2 exp lifetime with independent anisotropy)','Distribution Fit - Global Model'}))
            ...
            h.Result_Plot_Aniso.Parent = h.Fit_Plots_Panel;
...
panel_copy = copyobj(h.Fit_Plots_Panel,f);
...
if ~isequal(obj,  h.Microtime_Plot_Export) %%% Exporting fit result
    ...
    tab = cell2table(res,'ColumnNames',h.FitPar_Table.ColumnName,'VariableNames',{'Result','CI_lower','CI_upper'});
...
Parameters{1} = {'Tau [ns]','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{2} = {'Tau1 [ns]','LB','UB','Fixed','Tau2 [ns]','LB','UB','Fixed','Fraction 1','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{3} = {'Tau1 [ns]','LB','UB','Fixed','Tau2 [ns]','LB','UB','Fixed','Tau3 [ns]','LB','UB','Fixed','Fraction 1','LB','UB','Fixed','Fraction 2','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{4} = {'Tau1 [ns]','LB','UB','Fixed','Tau2 [ns]','LB','UB','Fixed','Tau3 [ns]','LB','UB','Fixed','Tau4 [ns]','LB','UB','Fixed','Fraction 1','LB','UB','Fixed','Fraction 2','LB','UB','Fixed','Fraction 3','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{5} = {'Tau [ns]','LB','UB','Fixed','beta','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{6} = {'Center R [A]','LB','UB','Fixed','Sigma R [A]','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','R0 [A]','LB','UB','Fixed','TauD0 [ns]','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{7} = {'Center R [A]','LB','UB','Fixed','Sigma R [A]','LB','UB','Fixed','Fraction Donly','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','R0 [A]','LB','UB','Fixed','TauD0 [ns]','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{8} = {'Center R1 [A]','LB','UB','Fixed','Sigma R1 [A]','LB','UB','Fixed','Center R2 [A]','LB','UB','Fixed','Sigma R2 [A]','LB','UB','Fixed','Fraction 1','LB','UB','Fixed','Fraction Donly','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','R0 [A]','LB','UB','Fixed','TauD0 [ns]','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{9} = {'Center R1 [A]','LB','UB','Fixed','Sigma R1 [A]','LB','UB','Fixed','Center R2 [A]','LB','UB','Fixed','Sigma R2 [A]','LB','UB','Fixed','Fraction 1','LB','UB','Fixed','Fraction Donly','LB','UB','Fixed','Scatter','LB','UB','Fixed','Background','LB','UB','Fixed','R0 [A]','LB','UB','Fixed','TauD(R0) [ns]','LB','UB','Fixed','TauD01 [ns]','LB','UB','Fixed','TauD02 [ns]','LB','UB','Fixed','Fraction TauD01','LB','UB','Fixed','Scatter Donly','LB','UB','Fixed','Background Donly','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{10} = {'Tau [ns]','LB','UB','Fixed','Rho [ns]','LB','UB','Fixed','r0','LB','UB','Fixed','r_infinity','LB','UB','Fixed','Scatter Par','LB','UB','Fixed','Scatter Per','LB','UB','Fixed','Background Par','LB','UB','Fixed', 'Background Per','LB','UB','Fixed', 'l1','LB','UB','Fixed','l2','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{11} = {'Tau1 [ns]','LB','UB','Fixed','Tau2 [ns]','LB','UB','Fixed','Fraction 1','LB','UB','Fixed','Rho [ns]','LB','UB','Fixed','r0','LB','UB','Fixed','r_infinity','LB','UB','Fixed','Scatter Par','LB','UB','Fixed','Scatter Per','LB','UB','Fixed','Background Par','LB','UB','Fixed', 'Background Per','LB','UB','Fixed', 'l1','LB','UB','Fixed','l2','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{12} = {'Tau [ns]','LB','UB','Fixed','Rho1 [ns]','LB','UB','Fixed','Rho2 [ns]','LB','UB','Fixed','r0','LB','UB','Fixed','r2','LB','UB','Fixed','Scatter Par','LB','UB','Fixed','Scatter Per','LB','UB','Fixed','Background Par','LB','UB','Fixed', 'Background Per','LB','UB','Fixed', 'l1','LB','UB','Fixed','l2','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{13} = {'Tau1 [ns]','LB','UB','Fixed','Tau2 [ns]','LB','UB','Fixed','Fraction 1','LB','UB','Fixed','Rho1 [ns]','LB','UB','Fixed','Rho2 [ns]','LB','UB','Fixed','r0','LB','UB','Fixed','r2','LB','UB','Fixed','Scatter Par','LB','UB','Fixed','Scatter Per','LB','UB','Fixed','Background Par','LB','UB','Fixed', 'Background Per','LB','UB','Fixed', 'l1','LB','UB','Fixed','l2','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
Parameters{14} = {'Tau1 [ns]','LB','UB','Fixed','Tau2 [ns]','LB','UB','Fixed','Fraction 1','LB','UB','Fixed','Rho1 [ns]','LB','UB','Fixed','Rho2 [ns]','LB','UB','Fixed','r0','LB','UB','Fixed','r_infinity1','LB','UB','Fixed','r_infinity2','LB','UB','Fixed','Scatter Par','LB','UB','Fixed','Scatter Per','LB','UB','Fixed','Background Par','LB','UB','Fixed', 'Background Per','LB','UB','Fixed', 'l1','LB','UB','Fixed','l2','LB','UB','Fixed','IRF Shift','LB','UB','Fixed'};
...
switch obj
    case {h.Menu.Export_MIPattern_Fit, h.Menu.Export_MIPattern_Data}
        %%% export the fitted microtime pattern for use in fTau filter
        %%% generation
    ...
    case h.FitResultToClip
        ...
        res = [h.FitPar_Table.ColumnName,h.FitPar_Table.Data(:,1)];
        if ~all(isnan(TauFitData.ConfInt(:)))
            if size(TauFitData.ConfInt,1) == size(res,1)
                res = [res, num2cell(TauFitData.ConfInt)];
            else                
