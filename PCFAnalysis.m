...
switch mode
    ...
    case 3 %%% Exports mean intensity\lifetime plot
        ...
        'defaultAxesFontName','Arial',...
        'defaultTextFontName','Arial',...
        'Position',[100 100 ScaleX*size(CData,2)+125 ScaleY*size(CData,1)/PCFData.Data{File}.PairInfo.ScanFreq*Rebin*10+ScaleY*15+85]);
    
        Exp.axes1 = axes(...
            'Parent',Exp.fig,...
            'Units','points',...
            'FontSize',12,...
            'Position',[50 ScaleY*15+40 ScaleX*size(CData,2) ScaleY*size(CData,1)/PCFData.Data{File}.PairInfo.ScanFreq*Rebin*10],...
            'NextPlot', 'add',...
            'XLim',[0.5 size(CData,2)+0.5],...
            'YLim',[0.5 size(CData,1)+0.5],...
            'YDir','reverse',...
       ...
       Exp.axes2.XLabel.FontSize = 14;               
        ...
        Exp.colbar = colorbar(...
            ...
            'FontSize',12,...
            'Units','points',...
            'Position', [ScaleX*size(CData,2)+60 ScaleY*15+40 10 ScaleY*size(CData,1)/PCFData.Data{File}.PairInfo.ScanFreq*Rebin*10],...
            'Location','eastoutside');
