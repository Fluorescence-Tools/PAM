...
h.Particle_Save_Method = uicontrol(...
    ...
    'String',{'Save Average',...
    'Save FLIM Trace',...
    'Save Text', 'Save Tiff Mat', 'Save Tiff Text'});
%%% Frames to use
...
%%% Loads Data
    ...
    ParticleData.Data.TauP=[];
    ParticleData.Data.TauM=[];
    ParticleData.Data.g=[];
    ParticleData.Data.s=[];
...
%     Part_Array (:, 10) = cellfun(@(X) X, Part_Array(:, 10), 'UniformOutput',false);
...
TauP=ParticleData.Data.TauP;
TauM=ParticleData.Data.TauM;
g=ParticleData.Data.g;
s=ParticleData.Data.s;
Regions =ParticleData.Regions; % removes particle regions with invalid phasor information

save(fullfile(PathName,FileName), 'TauP', 'TauM', 'g', 's', 'Lines', 'Pixels', 'Intensity','Frames','Regions');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Save the Tiff particle data as a text or excel file
